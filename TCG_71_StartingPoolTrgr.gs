...
function onOpenTCGStartPool_Master() {
  ...
  FileMenu.push(null);
  FileMenu.push({name:'Populate Current Player Starting Pool (Card DB)', functionName:'fcnPopulatePlayerDB'});
  FileMenu.push({name:'Populate All Players Starting Pool (Card DB)',    functionName:'fcnPopulateAllPlayerDB'});

// **********************************************
// function fcnPostMatchResultsTCG()
//
...
function fcnPostMatchResultsTCG(ss, shtConfig, ResponseData, MatchingRspnData, MatchID, MatchData) {
  
  Logger.log("Routine: fcnPostMatchResultsTCG");
  ...
  if (MatchValidPT1[0] == 1 && MatchValidPT2[0] == 1){
    ...
    if(exePostRoundResult == "Enabled") {
      ...
      MatchData = fcnPostRoundResultTCG(ss, cfgEvntParam, cfgColRspSht, cfgColRndSht, cfgColMatchRslt, ResultData, MatchData);
    }
  }
...
// **********************************************
// function fcnPostRoundResultTCG()
//
...
function fcnPostRoundResultTCG(ss, cfgEvntParam, cfgColRspSht, cfgColRndSht, cfgColMatchRslt, ResultData, MatchData) {
  
  Logger.log("Routine: fcnPostResultRoundTCG");
  ...
  var colRndCustom4 =  cfgColRndSht[12][0];
  var colRndMatchup =  cfgColRndSht[13][0];
